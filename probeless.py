...
if path.isfile(dirName+'/activations_train_new.json') == False:
...
if path.isfile(dirName+'/activations_test_new.json') == False:
    transformers_extractor.extract_representations('bert-base-multilingual-cased',
        file_test_sentences,
...
activations_train, num_layers_train = data_loader.load_activations(dirName+'/activations_train_new.json', 768, is_brnn=True)

activations_test, num_layers_test = data_loader.load_activations(dirName+'/activations_test_new.json', 768, is_brnn=True)
