...
parser = argparse.ArgumentParser(description='Probe on mBERT')
...
for l in range(0, 13):
    ...
    probe_layer = linear_probe.train_logistic_regression_probe(layer_train, y_train_balanced, lambda_l1=l1, lambda_l2=l2, num_epochs=epochs)
